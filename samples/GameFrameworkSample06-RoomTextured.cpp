...
int woden_main(int argc, const char **argv)
{
    ...
    Woden::Rendering::MaterialPtr floorMaterial = Woden::Assets::ResourceCache::Get()->getOrLoadMaterial("assets/materials/floor/mossy-cobblestone.wdmat");
    Woden::Rendering::MaterialPtr ceilingMaterial = floorMaterial;
    Woden::Rendering::MaterialPtr wallMaterial = Woden::Assets::ResourceCache::Get()->getOrLoadMaterial("assets/materials/bricks/brick-wall-006.wdmat");
